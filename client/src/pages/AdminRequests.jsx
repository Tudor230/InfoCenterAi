                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            <input
                                ...
                                className="w-64 py-2 pl-10 pr-4 text-sm border rounded-lg border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600"
                            />
                        ...
                        <select
                            ...
                            className="px-4 py-2 text-sm bg-white border rounded-lg border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600"
                        >
